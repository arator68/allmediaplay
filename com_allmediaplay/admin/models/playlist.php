 ...
 */
class AllMediaPlayModelPlaylist extends JModelAdmin
{
    ...
    {
        // Get the form.
        $form = $this->loadForm('com_allmediaplay.playlist', 'playlist', array('control' => 'jform', 'load_data' => $loadData));
        if (empty($form))
        {
            return false;
        }
    ...
    protected function loadFormData()
    {
        ...
        $data = JFactory::getApplication()->getUserState('com_allmediaplay.edit.tag.data', array());
        if (empty($data))
        {
            $data = $this->getItem();
        }
    ...
    public function getTable($type = 'Tag', $prefix = 'AllMediaPlayTable', $config = array())
    {
