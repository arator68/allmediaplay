 ...
 *
 */
class AllMediaPlayViewPlayer extends JView
{
    ...
    protected function addToolBar()
    {
        ...
        JToolBarHelper::title($isNew ? JText::_('COM_ALLMEDIAPLAY_MANAGER_ALLMEDIAPLAY_EDIT') : JText::_('COM_ALLMEDIAPLAY_MANAGER_ALLMEDIAPLAY_EDIT'), 'player');
    ...
    protected function setDocument()
    {
        ...
        $document->addScript(JURI::root() . "/administrator/components/com_allmediaplay/views/player/submitbutton.js");
