...
<div id="editcell">
            ...
            <tr>
                <td class="key">
                    <label for="folder" class="hasTip" title="<?php
                        echo JText::_('COM_ALLMEDIAPLAY_FORM_PLAYLISTS_FOLDER');?>::<?php 
                        echo JText::_('COM_ALLMEDIAPLAY_FORM_PLAYLISTS_FOLDER_DESCRIPTION');?>"><?php
                        echo JText::_('COM_ALLMEDIAPLAY_FORM_PLAYLISTS_FOLDER');?>:</label>
                </td>
    ...
    <fieldset class="adminform">
        <legend><?php echo JText::_('COM_ALLMEDIAPLAY_FORM_PLAYLISTS');?></legend>
...
<input type="hidden" name="option" value="com_allmediaplay" />
