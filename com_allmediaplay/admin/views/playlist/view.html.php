 ...
 *
 */
class AllMediaPlayViewPlaylist extends JView
{
    ...
    protected function addToolBar()
    {
        ...
        if ($isNew)
        {
            ...
            JToolBarHelper::cancel('playlist.cancel', 'JTOOLBAR_CANCEL');
        }
        else
        {
            ...
            if ($canDo->get('core.create'))
            {
                JToolBarHelper::custom('playlist.save2copy', 'save-copy.png', 'save-copy_f2.png', 'JTOOLBAR_SAVE_AS_COPY', false);
            }
