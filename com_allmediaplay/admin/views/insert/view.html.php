 ...
 * Insert View
 */
class AllMediaPlayViewInsert extends JView
{
    /**
    ...
    function display($tpl = null) {
        ...
        JHTML::script($js_ins, 'administrator/components/com_allmediaplay/assets/');
        //$doc->addScript('/administrator/components/com_allmediaplay/assets/popup-insert.js');
        //JHTML::script('administrator/components/com_allmediaplay/assets/popup-insert.js');
