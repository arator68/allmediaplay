...
require_once(JPATH_COMPONENT_ADMINISTRATOR.DS.'helpers'.DS.'helper_xml.php');

class AllMediaPlayPlaylistHelper extends JObject {

    var $_filename = null;

    var $_lasterror = null;

    function AllMediaPlayPlaylistHelper($filename) {
